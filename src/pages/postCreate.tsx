          ...
          <Form className = 'flex flex-col gap-6 items-center'>
            <div className={mediumScreen ? "flex items-center justify-center w-full mt-10" : "flex items-center justify-center w-full"}>
              <label  className="flex flex-col items-center justify-center md:w-[380px] w-[290px] h-44 md:h-64 border-2 border-gray-300 px-4 rounded-lg cursor-pointer bg-gray-200 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                <div className="flex flex-col items-center justify-center pt-3 pb-6 gap-6">
              ...
              <div className = {mediumScreen ? 'flex flex-row gap-2' : 'flex flex-col gap-2'}>
                <div className = 'flex flex-col gap-1'>
                  ...
                  <Field type="text" id="title" name="title" placeholder='Firulais' className='w-[220px] text-sm rounded-md h-9 p-4 border-gray-200 border-[1px] outline-none focus:border-orange-200 duration-500'/>
                </div>
                
                <div className = 'flex flex-col gap-1'>
                  <label htmlFor="location" className='font-semibold'>Ubicación</label>
                  <Field type="text" id="location" name="location" placeholder='Saenz Valiente 1174, Martínez' className='w-[300px] text-sm rounded-md h-9 p-4 border-gray-200 border-[1px] outline-none focus:border-orange-200 duration-500'/>
                </div>
              </div>
              <div className = {mediumScreen ? 'flex flex-row gap-2' : 'flex flex-row gap-2'}>
                <div className = 'flex flex-col gap-1'>
                  <label htmlFor="" className = 'font-semibold'>Especie</label>
                  <Field type="text" id="especie" name="especie" placeholder='Perro' className='w-[145px] text-sm rounded-md h-9 p-4 border-gray-200 border-[1px] outline-none focus:border-orange-200 duration-500'/>
                </div>
                
                <div className = 'flex flex-col gap-1'>
                  <label htmlFor="location" className='font-semibold'>Raza</label>
                  <Field type="text" id="raza" name="raza" placeholder='Border Collie' className='w-[145px] text-sm rounded-md h-9 p-4 border-gray-200 border-[1px] outline-none focus:border-orange-200 duration-500'/>
                </div>
              </div>
